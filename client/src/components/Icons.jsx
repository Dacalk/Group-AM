export const icons = {
  ...
  refresh: "M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8m0 0V3m0 5h5M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16m0 0h-5m5 0v5",
}

export function Icon({ path, size = 16, color = 'currentColor', className = '' }) {
  return (
    <svg
      width={size}
      height={size}
